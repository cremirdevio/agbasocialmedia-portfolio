...
<body>
    <div class="main">
        ...
        <header class="bg-white border-black border-[3px] p-4 flex justify-center">
            <div class="text-5xl md:text-8xl font-bold">agbasocialmedia</div>
        </header>

        <!-- Hero Section -->
        <section class="flex flex-col md:flex-row align-center bg-[#FFD1D4] border-black border-t-0 border-[3px] px-8 md:pl-32 md:pr-0 md:h-[800px] py-16 md:py-0 relative">
            <div class="md:hidden w-32 h-32 border-black bg-[#E3B100] border-[3px] absolute top-16 right-8 animate-[wiggle_2s_ease-in-out_infinite]"></div>
            <div class="w-full md:w-2/5 flex flex-col justify-center overflow mt-8">
                <h3 class="text-xs md:text-xl -mb-4 ml-1 md:-mb-8 md:ml-4">Esther Alade</h3>
                <h1 class="text-7xl md:text-9xl font-bold md:font-normal bg-green z-10 flex flex-col">
                    <span class="-mb-4">agba</span>
                    <span>socialmedia</span>
                </h1>
                <p class="text-xl md:text-2xl font-light my-6">Alade Esther is a social media manager who is passionate about helping small business owners user and see social media as a tool to grow their business presence online.</p>

                <p class="text-xl md:text-2xl font-light"> She strongly believes that with a great social media strategy, consistency and patience, a business can grow online.</p>

                <a href="javascript::void()" class="mt-6 h-16 w-64 flex align-center justify-center px-8 bg-black text-white text-2xl md:text-2xl py-4 hover:shadow-[8px_8px_0_0_#E3003F] transition">Let's Talk</a>
                <div class="md:hidden w-16 h-16 border-black bg-[#E3B100] border-[3px] mt-8 animate-[bounce_2s_ease-in-out_infinite]"></div>
            </div>
            <div class="hidden md:block bg-[#E3B100] border-black border-l-[3px] h-full w-3/5">
            </div>
        </section>

        <!-- What I Do -->
        <section class="flex flex-col md:flex-row align-center bg-[#FF5E8A] border-black border-t-0 border-[3px] px-8 md:px-32 py-24 overflow-hidden">
            <div class="hidden md:block w-2/5 h-full md:h-[1000px] bg-[#FFD1D4] border-black border-[3px]"></div>
            <div class="w-full md:w-3/5 pl-12 md:pl-12 relative">
                <h1 class="text-8xl">What I Do?</h1>
                <div class="md:hidden w-[80px] h-full bg-[#FFD1D4] border-black border-[3px] absolute -left-12"></div>
                ...
                <div class="my-8 flex flex-col gap-y-8">
                    @foreach(range(1,6) as $service)
                        <div class="flex w-full bg-[#FFD1D4] border-black border-[3px] h-32 overflow-hidden cursor-pointer hover:shadow-[12px_12px_0_0_#000] transition">
        ...
        <!-- Reviews -->
        <section class="bg-[#57E894] border-black border-t-0 border-[3px] md:h-[800px]">
            <div class="h-24 bg-[#2B5C40] border-b-[3px] border-black flex flex-col justify-center align-center">
                <h1 class="text-5xl md:text-6xl px-8 md:px-32 h-fit">Client Talking</h1>
            </div>

            <!-- Reviewlist -->
            <div>
                <div class="flex flex-col md:flex-row justify-around px-8 md:px-32 py-16">
                    <div class="w-32 h-32 md:w-80 md:h-80 bg-[#FFD1D4] border-black border-[3px] md:rounded-full"></div>
                    <div class="pt-10 md:pt-24 w-full md:w-3/5 self-end">
                        <p class="text-2xl md:text-4xl mb-8 leading-normal">“Originally, I took pre-orders for my Trend Reports on Gumroad. But I received... exactly $0. So I changed tactics: I made half of my report free, and the other half paid. Today, 99% of Trends.VC revenue is recurring in the form of annual and quarterly subscriptions.”</p>

                        <span class="mt-12 bg-black text-white text-2xl px-8 py-4 h-24">
            ...
            <!-- ReviewList Control -->
            <div class="flex justify-end px-32 gap-x-5 mb-8">
        ...
        <!-- Call To Action -->
        <section class="flex flex-col md:flex-row bg-[#FFD1D4] px-8 md:px-32 py-32">
            <h1 class="w-2/3 text-7xl md:text-9xl font-light">Ready to <br> talk growth?</h1>
            <div class="w-64 h-64 md:w-80 md:h-80 bg-black mt-12 md:mt-0 flex flex-col justify-center align-center rounded-full ">
        ...
        <!-- Socials -->
        <footer class="flex flex-col md:flex-row pl-8 md:pl-32 py-12 bg-white border-black border-t-[3px]">
            <div class="w-full md:w-1/3">
                <p class="text-xl">agbasocialmedia@gmail.com</p>
            </div>
            <div class="bg-[#E3003F] text-black h-[96px] overflow-hidden w-full md:w-2/3 border-black border-[3px] border-r-0 flex">
                <!-- IG -->
                <div class="w-[96px] h-[96px] border-black border-r-[3px] flex justify-center align-center py-4 cursor-pointer  ">
